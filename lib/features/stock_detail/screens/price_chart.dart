...
class _PriceChartState extends State<PriceChart> {
  ...
  static const _timeframes = ['1D', '1W', '1M', '3M', '6M', '1Y', '5Y'];
  static const _intradayFrames = ['1D'];
  ...
  void initState() {
    super.initState();
    if (_isIntraday) _loadIntraday('5m');
  }
  ...
  List<dynamic> get _filtered {
    ...
    switch (_timeframe) {
      ...
      case '6M': return data.length > 180 ? data.sublist(data.length - 180) : data;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // Controls row: timeframe pills, candlestick toggle as a small trailing icon
        Row(
          children: [
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: _timeframes.map((tf) => GestureDetector(
                    onTap: () {
                      setState(() { _timeframe = tf; _touchedIndex = null; });
                      if (_intradayFrames.contains(tf)) _loadIntraday('5m');
                    },
                    child: Container(
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Icon(Icons.candlestick_chart, color: _isCandlestick ? AppColors.primary : AppColors.textMuted, size: 20),
              ),
            ),
          ],
        ),
