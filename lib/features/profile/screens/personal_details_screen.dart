...
class _PersonalDetailsScreenState extends State<PersonalDetailsScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await dio.patch(
        'https://stock-backend-11rm.onrender.com/api/v1/auth/profile',
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: _user?['avatar_url'] != null
                                ? DecorationImage(image: NetworkImage('https://stock-backend-11rm.onrender.com${_user!['avatar_url']}'), fit: BoxFit.cover)
                                : null,
                          ),
